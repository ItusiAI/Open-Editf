        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                {isZh 
                  ? 'Editf使用Cookie和类似技术来增强您的用户体验，分析网站使用情况，并提供相关的AI编辑服务功能。'
                  : 'Editf uses cookies and similar technologies to enhance your user experience, analyze website usage, and provide relevant AI editing service features.'
                }
              </p>
            </section>
