        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                {isZh
                  ? '欢迎使用Editf（"我们"、"我们的"或"本服务"）。Editf是一个专业的AI编辑平台，为用户提供包括但不限于图片编辑、AI图像生成、文本处理、视频编辑等AI驱动的创意工具。'
                  : 'Welcome to Editf ("we", "our", or "the service"). Editf is a professional AI editing platform that provides users with AI-powered creative tools including but not limited to image editing, AI image generation, text processing, video editing, and more.'
                }
              </p>
              <p className="mb-4">
                {isZh 
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">
                {isZh ? '3. AI编辑服务使用规则' : '3. AI Editing Service Usage Rules'}
              </h2>
              <p className="mb-4">
                {isZh ? '我们的AI编辑服务包括但不限于：' : 'Our AI editing services include but are not limited to:'}
              </p>
              <ul className="list-disc list-inside mb-4 space-y-2">
                <li>
                  <strong>{isZh ? 'AI图像编辑' : 'AI Image Editing'}</strong>：
                  {isZh ? '智能图片编辑、修图、美化处理' : 'Intelligent image editing, photo retouching, and beautification'}
                </li>
                <li>
                  <strong>{isZh ? 'AI图像生成' : 'AI Image Generation'}</strong>：
                  {isZh ? '基于文本描述生成高质量图像' : 'Generate high-quality images based on text descriptions'}
                </li>
                <li>
                  <strong>{isZh ? 'AI视频编辑' : 'AI Video Editing'}</strong>：
                  {isZh ? '智能视频剪辑、特效添加和内容优化' : 'Intelligent video editing, effects addition, and content optimization'}
                </li>
                <li>
                  <strong>{isZh ? 'AI文本处理' : 'AI Text Processing'}</strong>：
                  {isZh ? '智能文本编辑、翻译和内容创作' : 'Intelligent text editing, translation, and content creation'}
                </li>
              </ul>
              ...
              <p className="mb-4">
                {isZh ? '在使用我们的AI编辑服务时，您不得：' : 'When using our AI editing services, you may not:'}
              </p>
              <ul className="list-disc list-inside mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                {isZh ? '您保留对输入到我们AI编辑平台中的原始内容的所有权利。' : 'You retain all rights to the original content you input into our AI editing platform.'}
              </p>
              <p className="mb-4">
                <strong>{isZh ? 'AI生成内容' : 'AI Generated Content'}</strong>：
                {isZh ? '通过我们的AI编辑工具生成的内容版权归您所有。您可以自由使用、修改、分发和商业化这些内容。' : 'The copyright of content generated through our AI editing tools belongs to you. You may freely use, modify, distribute, and commercialize this content.'}
              </p>
              <p className="mb-4">
                <strong>{isZh ? '我们的知识产权' : 'Our Intellectual Property'}</strong>：
                {isZh ? 'Editf平台、AI模型、算法和相关技术受知识产权法保护，归我们所有。' : 'The Editf platform, AI models, algorithms, and related technologies are protected by intellectual property laws and belong to us.'}
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                {isZh ? '我们提供免费和付费的AI编辑服务。付费服务的具体条款包括：' : 'We offer both free and paid AI editing services. Specific terms for paid services include:'}
              </p>
              <ul className="list-disc list-inside mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                {isZh 
                  ? '我们的AI编辑服务按"现状"提供。我们不保证AI生成内容的准确性、完整性或适用性。用户应对AI生成内容进行审查，并承担使用风险。'
                  : 'Our AI editing services are provided "as is". We do not guarantee the accuracy, completeness, or suitability of AI-generated content. Users should review AI-generated content and assume the risks of use.'
                }
              </p>
              <ul className="list-disc list-inside mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside mb-4 space-y-2">
                ...
                <li>{isZh ? '网站：https://editf.com' : 'Website: https://editf.com'}</li>
              </ul>
            </section>
          </div>
        </div>
